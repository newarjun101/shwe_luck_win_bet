...
TwoDMainModel twoDMainModelFromJson(String str) =>
    TwoDMainModel.fromJson(json.decode(str));

String twoDMainModelToJson(TwoDMainModel data) => json.encode(data.toJson());
...
class TwoDMainModel {
  ...
  final List<TwoD> twoD;
  final List<OverallAmount> overallAmounts;

  factory TwoDMainModel.fromJson(Map<String, dynamic> json) => TwoDMainModel(
    id: json["id"],
    name: json["name"],
    ...
    twoD:
    List<TwoD>.from(json["twod"].map((x) => TwoD.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "twod": List<dynamic>.from(twoD.map((x) => x.toJson())),
    "overall_amounts":
...
class TwoD {
  ...
  factory TwoD.fromJson(Map<String, dynamic> json) => TwoD(
    id: json["id"],
